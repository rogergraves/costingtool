namespace :app do
  task :reset_click_tables => :environment do
    ...
    table1_array1 = InkArray.create(:click_table_id => table1.id, :name => 'Multicolor', :color_range_start => 1, :color_range_end => '', :black => 0)
    ...
    table1_array1_tier2 = Tier.create(:ink_array_id => table1_array1.id, :name => 'Tier 2', :volume_range_start => 10000001,  :volume_range_end => '', :price => 0.0105882352941176)

    table1_array2_tier1 = Tier.create(:ink_array_id => table1_array2.id, :name => 'Tier 1', :volume_range_start => 0, :volume_range_end => '', :price => 0.00941176470588235)

    table1_array3_tier1 = Tier.create(:ink_array_id => table1_array3.id, :name => 'Tier 1', :volume_range_start => 0, :volume_range_end => '', :price => 0.00705882352941176)
    ...
    table2_array1 = InkArray.create(:click_table_id => table2.id, :name => 'Multicolor', :color_range_start => 1, :color_range_end => '', :black => 0)
    table2_array2 = InkArray.create(:click_table_id => table2.id, :name => 'Black (K only)', :color_range_start => '', :color_range_end => '', :black => 1)
    ...
    table2_array1_tier4 = Tier.create(:ink_array_id => table2_array1.id, :name => 'Tier 4', :volume_range_start => 10000001, :volume_range_end => '', :price => 0.0195)
    ...
    table2_array2_tier2 = Tier.create(:ink_array_id => table2_array2.id, :name => 'Tier 2', :volume_range_start => 10000001, :volume_range_end => '', :price => 0, :black_price => 0.0095)
    ...
    table3_array1 = InkArray.create(:click_table_id => table3.id, :name => 'Multicolor', :color_range_start => 1, :color_range_end => '', :black => 0)

    table3_array2 = InkArray.create(:click_table_id => table3.id, :name => '1 Color Raised Printing', :color_range_start => 1, :color_range_end => '', :black => 1)
    ...
    table3_array1_tier6 = Tier.create(:ink_array_id => table3_array1.id, :name => 'Tier 6', :volume_range_start => 3600001, :volume_range_end => '', :price => 0.0125)


    table3_array2_tier1 = Tier.create(:ink_array_id => table3_array2.id, :name => 'Tier 1', :volume_range_start => 0, :volume_range_end => '', :price => 0, :black_price => 0.009)


    table3_array3_tier1 = Tier.create(:ink_array_id => table3_array3.id, :name => 'Tier 1', :volume_range_start => 0, :volume_range_end => '', :price => 0, :black_price => 0.0101)
