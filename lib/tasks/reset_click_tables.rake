namespace :app do
  task :reset_click_tables => :environment do
    ...
    table1 = ClickTable.create(:name => '72xx Click Pricing', :description => 'Tiered Pricing for 72xx series presses')
    ...
    table3_array1 = InkArray.create(:click_table_id => table3.id, :name => 'Multicolor', :color_range_start => 1, :color_range_end => 3, :black => 0)

    table3_array2 = InkArray.create(:click_table_id => table3.id, :name => '1 Color Raised Printing', :color_range_start => 1, :color_range_end => 1, :black => 1)
